<script lang="ts" setup>
    ...
    watch(() => folderStore.currentPath, (newPath) => {
    ...
    async function handleOpenSearchConfig() {
        try {
            ...
            await message(`打开搜索配置失败：${String(error)}`, { title: "错误", kind: "error" });
        }
    }
</script>
    ...
    <div class="search-bar">
        ...
        <div class="open-folder">
            ...
            <el-tooltip content="设置搜索选项" placement="bottom" effect="light" popper-class="search-tooltip">
                <el-button type="default" style="font-size: 16px; background-color: transparent;" size="default"
                    :icon="icons.Setting" @click="handleOpenSearchConfig" />
            </el-tooltip>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    :global(.search-tooltip.el-popper[data-popper-placement^='bottom'] .el-popper__arrow::before) {
        background-color: #dcdfe6 !important;
